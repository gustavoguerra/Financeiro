namespace Financeiro.Domain.Cadastro
{
    public class Empresa : Entity
    {
        ...
        public Empresa(string NomeFantasia, string RazaoSocial, string CpfCnpj, string Email, string Telefone, string Celular, string Cep, string Endereco, string Numero, string Bairro, string Cidade, string Estado, string Pais)
        {
